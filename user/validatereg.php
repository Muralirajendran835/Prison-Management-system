...
$Filenum=mysqli_real_escape_string($con,$_POST['Filenum']);
 ...
 $sql = "INSERT INTO registration (id, Full_Name, DOB, datein, dateout, Address, Country, Gender, Education, Marital, Offence, Sentence,  File_num) 
VALUES ('$Nid', '$Fname', '$dateofbirth', '$datein', '$dateout', '$address', '$country', '$Gender', '$education', '$status', '$offence', '$sentence',  '$Filenum');";
