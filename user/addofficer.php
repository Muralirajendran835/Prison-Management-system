...
<div id="content" class="ctrdiv">
	<form id="frmReg" method="POST" action="validateofficer.php">
       <h2 id="hdr_title">Officer Registration Form  </h2>
            ...
            <div class="control_input">
                <label for="fullname" class="label">Full Name</label><input type="text" id="fullname" name="fullname" class="reg_fields" required/>
            </div>
            <div class="control_input">
            ...
            <div class="control_input">
                ...
                class="reg_fields" required  class="reg_fields"/>
            </div class="control_input">
