...
<td width="66%" bgcolor="#FFFFFF"><input type="text" name="Nationalid" size=8 maxlength=8 required /></td>
</tr>
<tr>
<td bgcolor="#FFFFFF"><b>File Number:</b></td>
<td bgcolor="#FFFFFF"><input type="text" name="Filenum" size=6 maxlength=7 required placeholder="vcp-001"/></td>
</tr>
<!-- <tr> 
...
<td bgcolor="#FFFFFF"><input type="text" name="Judge" required placeholder="Judge" size=25 maxlength=25 ></td>
</tr>
